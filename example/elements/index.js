...
const A = (props)=> {
    var { style, ... touchableProps } = props;
    return (
        <TouchableOpacity {...touchableProps}>
            <Text style={[stylesheet.a, { fontSize:em(1.5), color: styleVariables.anchorColor }, style]}>
                {props.children}
            </Text>
        </TouchableOpacity>
    );
...
module.exports = { init, em, Row, Flex, FormGroup, A, Container, Column, Text, Bold, H1, H2, H3, H4, H5, H6 };